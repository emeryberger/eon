...
implementation 
{
                                           ...
                                           datalen_t len, flashptr_t *save_ptr)
    {
        ...
        //call Console.decimal(sizeof(uint16_t));
        call Console.string("\n");
        TOSH_uwait(30000L);
#endif
    ...
    task void saveData()
    {
        ...
        /* Write the data */
        if(SUCCESS != call Array.set(Tarrindex, Tdata, Tlen, &local[indexif_id].buffer.ptr[Tindex]))
		//if (SUCCESS != call Array.set(Tarrindex, Tdata, Tlen, Tsave_ptr))
        {
#ifdef INDEX_DEBUG
...
#ifdef INDEX_DEBUG
        call Console.string("Array.setDone handler returning\n");
        TOSH_uwait(30000L);
#endif
    }
    ...
    {
#ifdef INDEX_DEBUG
        call Console.string("In Index.deletedata : Tarrindex ");
        call Console.decimal(Tarrindex);
        call Console.string(" indexif_id ");
        call Console.decimal(indexif_id);
        call Console.string(" Tindex ");
        ...
        {
#ifdef INDEX_DEBUG
            call Console.string("Deleting index data failed\n");
            TOSH_uwait(30000L);
#endif
            post FailRespond();
        }
