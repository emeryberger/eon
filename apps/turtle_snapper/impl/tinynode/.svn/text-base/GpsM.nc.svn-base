 ...
 *****************************************************************************/
	...
	void GGARecv(GPS_MsgPtr data)
	{
      ...
      //num satelites
		...
		dvalue = strtod(pdata,NULL);
		dtmp = dvalue*10;
		fix.hdilution = (uint8_t)dtmp;
		
		pdata = nmea_fields[9];
		dvalue = strtod(pdata,NULL);
		dtmp = dvalue;
		fix.altitude = (uint16_t)dtmp;
